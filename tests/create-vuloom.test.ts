...
import { createVuloomApp } from "../src/index.ts";

const tempDirs: string[] = [];

async function readInstalledVuloomVersion(): Promise<string> {
  ...
  if (!packageJson.version) {
    throw new Error(`Missing version in installed vuloom package: ${packageJsonPath}`);
  }
